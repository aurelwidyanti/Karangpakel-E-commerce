    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tambahkan Berita</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
          <div class="form-floating mb-3">
            <input id="uname" type="text" class="form-control" name="name_berita">
            <label for="uname">Judul :</label>
          </div>
          <div class="form-floating mb-3">
            <textarea class="form-control" name="isi_berita" style="height: 300px;"></textarea>
            <label for="floatingTextarea">Isi Berita</label>
          </div>
          <div class="text-center">
            <button type="submit" name="buat" class="btn btn-primary">Tambahkan Berita</button>
          </div>
        ...
        <?php
              if (isset($_POST['buat'])) {
                ...
                $edit=  mysqli_query($conn, "INSERT INTO berita SET name_berita='$name_berita',isi_berita='$isi_berita'");
              }
              ?>
